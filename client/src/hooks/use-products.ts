...
export type SortOrder = "lowToHigh" | "highToLow" | "smart"
...
export function useProducts() {
    ...
    const [sortOrder, setSortOrder] = useState<"lowToHigh" | "highToLow" | "smart">("smart")
    ...
    useEffect(() => {
        async function fetchProducts() {
            try {
                ...
                const landingMap: Record<string, Partial<FilterState>> = {
                    "itopya-hazir-sistem": { stores: ["itopya"] },
                    "vatan-hazir-sistem": { stores: ["vatan"] },
                    ...
                    "rtx-5080-hazir-sistem": { gpuSeries: ["RTX 5080"] },
                    "rtx-5090-hazir-sistem": { gpuSeries: ["RTX 5090"] },
                    "rtx-4060-hazir-sistem": { gpuSeries: ["RTX 4060"] },
                    "rx-9060-hazir-sistem": { gpuSeries: ["RX 9060"] },
                    "rx-9070-hazir-sistem": { gpuSeries: ["RX 9070"] },
                    "ryzen-5-hazir-sistem": { cpuSeries: ["RYZEN 5"] },
