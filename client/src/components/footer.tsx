          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="pt-1">
              <a
                ...
                target="_blank"
                rel="nofollow noreferrer"
                className="btn-press inline-flex items-center gap-1.5 rounded-full bg-rose-500/10 px-4 py-2 text-xs font-bold text-rose-500 hover:bg-rose-500 hover:text-white hover:shadow-lg hover:shadow-rose-500/25 transition-all duration-300"
              >
