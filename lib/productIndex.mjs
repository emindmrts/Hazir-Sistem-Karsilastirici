...
import { recordPrices } from "./priceHistory.mjs";
...
export async function loadCatalog() {
  ...
  _cache = { fp, products };
  // Her rebuild'de günün fiyat anlık görüntüsünü fiyat geçmişine işle
  // (gece scrape sonrası ilk istekte günde bir kez tetiklenir).
  await recordPrices(products);
